/* Name: Khursheed Alam Khan					Dijkstra Algorithm Diameter
 * 20i-0496
 * SE-R
 */
...
//		                        FileHandler.writeFile();
            ...
            Integer Node = Collections.max(visitedDistance.entrySet(), Map.Entry.comparingByValue()).getKey();	// Gets the Node with Largest Shortest Distance
            Integer Value = Collections.max(visitedDistance.entrySet(), Map.Entry.comparingByValue()).getValue();	// Gets the Value of the Largest Shortest Distance
            System.out.println("Diameter of the graph is: "+Value);
            System.out.println("From Source: "+source+" to Largest Shortest Distance Node:"+Node);
     ...
     public static void main(String args[]) throws IOException 
     {
         ...
         handler.writeFileDiameterByDijkstra();
